...
void EnemyMove();							// 飞船移动
void MakeEnemyBullet0();						// 黄昏产生飞船子弹
void MakeEnemyBullet1();						// 黑夜产生飞船子弹
...
extern IMAGE background, ship, ship1, enemy, enemy1, smallenemy, smallenemy1, life, life1;
